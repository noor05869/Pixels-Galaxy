...
export function SiteHeader() {
  ...
  return <header className="site-header">
    ...
    <div className="header-actions"><button className="cart-button" aria-label="Open cart" onClick={openCart}><ShoppingBag /><span className="cart-count">{totalQuantity}</span></button><button className="menu-button" aria-label="Open menu" onClick={() => setOpen(true)}><Menu /></button></div>
