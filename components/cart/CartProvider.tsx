...
type CartValue = { lines: CartLine[]; totalQuantity: number; isOpen: boolean; addItem: (line: CartLine) => void; updateQuantity: (id: string, quantity: number) => void; removeItem: (id: string) => void; clearCart: () => void; openCart: () => void; closeCart: () => void };
