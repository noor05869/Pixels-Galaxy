...
export function PurchasePanel({ product }: { product: Product }) {
  ...
  return <div className="purchase-panel"><p className="kicker">ONLINE ONLY • AGES 3+</p><h2>{product.name}</h2>{product.reviews > 0 && <Stars rating={product.rating} count={product.reviews} />}<p className="product-description">{product.description}</p>
